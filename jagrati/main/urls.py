...
from .views import (AttendaceViewSet, ClassViewSet, EventViewSet,
                    GroupFeedbackViewSet, GroupSubjectViewSet, GroupViewSet,
                    StudentFeedbackViewSet, StudentProfileViewSet,
                    SyllabusViewSet, UserDetailAPIView, UserHobbyViewSet,
